...
<div class="container" >
    <div class="row justify-content-center">
        <div class="col-md-6 mt-5 offset-1">
            <div class="card">
                <div class="card-header ml-5 mt-5">
                    <h3 class=" offset-2">{{ __('LOGIN TO JCMS') }}</h3>
                </div>
                ...
                <div class="card-body justify-content-right">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-check justify-content-right">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-12">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link offset-md-1" href="{{ route('password.request') }}">
                                        {{ __('Forgot Your Password?') }}
                                    </a>
                                @endif

                                @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="md-3 offset-2 btn btn-outline-primary">Register</a>
                                @endif
                            </div>
